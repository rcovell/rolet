...
@extends('layouts.app')
{{-- @section('description', 'Helping people save money and time on all types of loans including; mortgage, automotive, business, personal and student.') --}}

@section('content')
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="leader-title">Downtown Kansas City Data Center</h2>
        <p class="leader">
